...
export const ROLE_PERMISSIONS: Record<UserRole, string[]> = {
  ...
  DepartmentChair: ["PATCH /api/v1/courses/*/instructor", "GET /api/v1/courses", "GET /api/v1/courses/*"],
  Registrar: ["PATCH /api/v1/courses/*/status", "GET /api/v1/courses", "GET /api/v1/courses/*"],
  Admin: ["*"],
