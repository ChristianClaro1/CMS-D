...
import { createCourseSchema, updateStatusSchema, updateCourseSchema } from "../validators/courseValidator";
import { createCourse, getCourseById, updateCourseStatus, checkDuplicateCourse, updateCourse, deleteCourse } from "../../../services/courseServices";
...
export async function update(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    if (error.message === "Duplicate course offering.") {
...
export async function remove(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    await logAudit(
      ...
      "COURSE_DELETED",
      id,
      { course_code: deleted.course_code, course_name: deleted.course_name },
      req.ip || undefined
    );
